...
@interface FriendXunZHangView ()<UICollectionViewDataSource,UICollectionViewDelegate>
...
- (UICollectionView *)collectionView {
    if (_collectionView == nil) {
        ...
        flowLayout.itemSize = CGSizeMake(_itemWidths,_itemWidths);
...
- (void)setItemWidths:(CGFloat)itemWidths{
    ...
    [_collectionView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.height.mas_offset(ws.itemWidths);
    }];
}
@end
